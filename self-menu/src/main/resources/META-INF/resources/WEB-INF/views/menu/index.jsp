...
<meta charset="UTF-8">
<title>菜单管理</title>
<link rel="stylesheet" href="/zph/menu/css/menu.css"/>
</head>
<body>
...
<script type="text/javascript" src="/zph/menu/js/jquery.js"></script>
<script type="text/javascript" src="/zph/menu/js/vue.js"></script>
<script type="text/javascript" src="/zph/menu/js/menu.js"></script>
