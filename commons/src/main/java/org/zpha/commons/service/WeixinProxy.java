...
import org.zpha.commons.domain.User;
import org.zpha.commons.domain.text.TextOutMessage;
import org.zpha.commons.service.TokenManager;
...
public class WeixinProxy {
	...
	public void sendText(String account, String openId, String content) {
		...
		try {
			...
			LOG.error("通过客服接口发生信息出现问题：" + e.getLocalizedMessage(), e);
		}
	}
